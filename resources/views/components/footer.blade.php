<footer id="footer" class="w-full z-50 mt-12 text-center bg-gray-600 dark:bg-gray-700 text-white">
    <div class="lg:hidden">
        <x-nav-links />
    </div>
    <div class="ml-auto mr-auto px-6 pt-6">
        <div class="flex justify-center mb-6">
            ...
            <a href="https://github.com/jurdunnn/pconte-com" target="_blank" type="button" class="rounded-full border-2 border-white text-white leading-normal uppercase hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out w-9 h-9 m-1">
                <svg aria-hidden="true"
                     focusable="false"
                     data-prefix="fab"
                     data-icon="github"
