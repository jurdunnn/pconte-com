<section>
    ...
    <div class="flex flex-wrap">
        ...
        <div class="grow-0 shrink-0 basis-auto select-none w-full xl:w-7/12">
            <div class="flex flex-wrap">
                <a href="#" class="mb-12 grow-0 shrink-0 hover:opacity-80 basis-auto w-full md:w-6/12 px-3 lg:px-6">
                    <div class="flex items-start">
                        ...
                        <div class="grow ml-6">
                            <p class="font-bold mb-1">Leave a review</p>
                            <p class="text-gray-500">Review services delivered</p>
                        </div>
                    </div>
                </a>
                ...
                <a href="#" class="mb-12 grow-0 shrink-0 hover:opacity-80 basis-auto w-full md:w-6/12 px-3 lg:px-6">
                    <div class="flex items-start">
                        ...
                        <div class="grow ml-6">
                            <p class="font-bold mb-1">Manage Booking</p>
                            <p class="text-gray-500">Manage your booking from the website.</p>
                        </div>
                    </div>
                </a>
                ...
                <a href="#" class="grow-0 shrink-0 hover:opacity-80 basis-auto w-full md:w-6/12 px-3 lg:px-6">
                    <div class="flex align-start">
                        ...
                        <div class="grow ml-6">
                            ...
                            <p class="text-gray-500">Found an issue with the site?</p>
                            <p class="text-gray-500">Submit a bug report!</p>
                        </div>
                    </div>
                </a>
