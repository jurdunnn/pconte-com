...
@section('content')
    <div class="bg-gray-200 dark:bg-gray-700">
        <div class="min-h-[100%] min-h-content mobile-container md:container text-gray-700 dark:text-gray-100">
            <div class="py-6">  
                <div class="m-auto px-6 md:px-12 xl:px-0">
                    <h2 class="hidden md:block font-bold ml-auto mr-auto py-8 text-yellow-500 text-center text-5xl max-w-md">Services</h2>
                    <div class="mx-auto grid gap-6 md:w-3/4 lg:w-full lg:grid-cols-3">
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl px-8 py-12 sm:px-12 lg:px-8">
                            ...
                            <div class="mt-8 space-y-4">
                                <h3 class="text-2xl font-semibold text-yellow-500">Emergency Callouts</h3>
                                <p class="mb-6">
                                ...
                                <a href="{{ route('services') }}#callouts" class="block font-medium text-yellow-500">Know more</a>
                            </div>
                        </div>
                        ...
                        <div class="px-8 py-12 sm:px-12 lg:px-8">
                            ...
                            <div class="mt-8 space-y-4">
                                ...
                                <a href="{{ route('services') }}#maintenance" class="block font-medium text-yellow-500">Know more</a>
                            </div>
                        </div>
                    </div>
                </div>
